export const description =
  'On this page, we’ll dive into the different communities endpoints you can use to manage communities programmatically.'
...
## List all communities {{ tag: 'GET', label: '/communities' }}
...
## Retrieve a community {{ tag: 'GET', label: '/communities/:id' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/communities/WAz8eIbvDR60rouK">
...
## Update a community {{ tag: 'PATCH', label: '/communities/:id' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="PATCH" label="/communities/WAz8eIbvDR60rouK">
...
## Delete a community {{ tag: 'DELETE', label: '/communities/:id' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="DELETE" label="/communities/WAz8eIbvDR60rouK">
