...
Attachments are how you share things in WhatsApp — they allow you to send all sorts of files to your contacts and groups. On this page, we'll dive into the different attachment endpoints you can use to manage attachments programmatically. We'll look at how to query, upload, update, and delete attachments. {{ className: 'lead' }}
...
## List all attachments {{ tag: 'GET', label: '/attachments' }}

<Row>
  <Col>

    This endpoint allows you to retrieve a paginated list of all your attachments (in a conversation if a chat id is provided). By default, a maximum of ten attachments are shown per page.

    ### Optional attributes

    <Properties>
      <Property name="chat_id" type="string">
        Limit to attachments from a given chat.
      </Property>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/attachments">
      ...
      "data": [
        {
          ...
          "file_url": "https://assets.whatsapp.chat/attachments/Invoice_room_service__Plaza_Hotel.pdf",
...
## Create an attachment {{ tag: 'POST', label: '/attachments' }}

<Row>
  <Col>

    This endpoint allows you to upload a new attachment to a chat. See the code examples for how to send the file to the WhatsApp API.
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="POST" label="/attachments">
...
## Retrieve an attachment {{ tag: 'GET', label: '/attachments/:id' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="GET" label="/attachments/Nc6yKKMpcxiiFxp6">
...
## Update an attachment {{ tag: 'PATCH', label: '/attachments/:id' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="PATCH" label="/attachments/Nc6yKKMpcxiiFxp6">
    ...
    ```json {{ title: 'Response' }}
    {
      ...
      "data": {
        ...
        "message_id": "LoPsJaMcPBuFNjg1",
        "filename": "Invoice_room_service__Plaza_Hotel.pdf",
        "file_url": "https://assets.whatsapp.chat/attachments/Invoice_room_service__Plaza_Hotel_updated.pdf",
        "file_type": "application/pdf",
        "file_size": 21352,
        "created_at": 692233200
      }
...
## Delete an attachment {{ tag: 'DELETE', label: '/attachments/:id' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Request" tag="DELETE" label="/attachments/Nc6yKKMpcxiiFxp6">
